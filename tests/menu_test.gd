extends SceneTree
## Main menu + lobby regression: the painted menu loads with five styled
## buttons; the Lobby scene hosts a real ENet server on port 8910,
...
func _run() -> void:
	...
	var buttons: VBoxContainer = menu.get_node("UI/Buttons")
